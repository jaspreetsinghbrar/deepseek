...
const PromptBox = ({ isLoading, setIsLoading }) => {
  ...
  const sendPrompt = async (e) => {
    ...
    try {
      ...
      //saving user prompts in chat array
      ...
      if (data.success) {
        ...
        // To get a typing word by word effect
        ...
        for (let i = 0; i < messageTokens.length; i++) {
          setTimeout(() => {
            ...
            selectedChat((prev) => {
              const updatedMesseges = [
                ...prev.messeges.slice(0, -1),
                assistantMessage,
              ];
              return { ...prev, messages: updatedMesseges };
            });
          }, i * 100);
        }
      } else {
  ...
  return (
    <form
      ...
      action=""
      className={`w-full ${
        selectedChat?.messeges.length > 0 ? "max-w-3xl" : "max-w-2xl"
