      ...
      <div>
          ...
          >
            ...
            <div
              className={`absolute w-max ${
                expand ? "left-1/2 -translate-1/2 top-12" : "-top-12 left-0"
        ...
        >
          ...
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none">
            New Chat
            <div className="w-3 h-3 absolute bg-black rotate-45 -bottom-1.5 left-4"></div>
          </div>
      ...
      <div>
        <div
          className={`flex items-center cursor-pointer group relative ${
            expand
              ? "gap-1 text-white/80 text-sm p-2.5 border border-primary hover:bg-white/10 cursor-pointer"
        ...
        >
          ...
          >
            <div className="relative bg-black w-max text-white text-sm p-3 rounded-lg shadow-lg">
